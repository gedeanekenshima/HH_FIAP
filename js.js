function AlteraRele1(){
    ...
    if(estado === "0"){
        ...
        document.getElementById("rele").innerHTML="<div class='LED_ON'></div>";
		document.getElementById("botao").innerHTML="<a href='/?desligar' class='botao'>Desliga</a>";
    } else {
        document.getElementById("estado").innerHTML="0";
        document.getElementById("rele").innerHTML="<div class='LED_OFF></div>";
...
function AlteraRele2(){
    ...
    if(estado_2 === "0"){
        ...
        document.getElementById("rele_2").innerHTML="<div class='LED_ON'></div>";
        ...
        document.getElementById("rele_2").innerHTML="<div class='LED_OFF'></div>";
